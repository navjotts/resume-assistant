...
async function train(name) {
    ...
    try {
        var result = await PythonConnector.invoke('train_classifier', name, 'LogisticRegression', 'tf-idf', data.samples, data.labels);
        console.log(result);
    }
    catch (e) {
...
async function test(name) {
    ...
    try {
        var result = await PythonConnector.invoke('test_classifier', name, 'LogisticRegression', 'sentence-embeddings', data.samples, data.labels);
        console.log(result);
    }
    catch (e) {
